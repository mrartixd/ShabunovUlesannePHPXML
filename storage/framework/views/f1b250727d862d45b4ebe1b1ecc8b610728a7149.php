...
<?php $news =\DB::select('select * from news'); ?>
  ...
  <div class="card-body">
    ...
    <h6 class="card-subtitle mb-2 text-muted"><?php echo e($new->pubdate); ?> &nbsp; <?php echo e($new->id_category); ?></h6>
    <p class="card-text"><?php echo e($new->description); ?></p>
    <a href="<?php echo e($new->link); ?>" class="card-link"><?php echo e($new->link); ?></a>
  </div>
</div>
